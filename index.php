...
<body class="home">
    ...
    <img class="img-rounded" src="images/fastfood.png" alt="" style="height:70px;">
</a>
        ...
        <!-- start: FOOTER -->
        <footer class="footer" style="length:20px">
            <div class="container">
                <!-- top footer statrs
                ...
                <div class="bottom-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 payment-options color-gray">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Near Lovely Professional University 
                            Phagwara, Punjab</p>
                            <h5>Phone: <a href="tel:+9198593435">9198593435</a></h5>
                        </div>
                        <div class="col-xs-12 col-sm-4 address color-gray">
